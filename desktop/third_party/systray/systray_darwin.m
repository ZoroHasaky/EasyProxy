// EasyProxy patch: rename the systray delegate to avoid colliding with Wails' AppDelegate during macOS linking.
...
@interface EasyProxySystrayAppDelegate: NSObject <NSApplicationDelegate>
  - (void) add_or_update_menu_item:(MenuItem*) item;
  - (IBAction)menuHandler:(id)sender;
  @property (assign) IBOutlet NSWindow *window;
  @end

  @implementation EasyProxySystrayAppDelegate
{
...
void registerSystray(void) {
  EasyProxySystrayAppDelegate *delegate = [[EasyProxySystrayAppDelegate alloc] init];
...
void runInMainThread(SEL method, id object) {
  [(EasyProxySystrayAppDelegate*)[NSApp delegate]
